...
respectively the Constant Editor settings for defining a default host and default user on the command
line are moved into the :ref:`site configuration <site-configuration>`. Please remove the mentioned
